...
namespace HealthInsurance.Controllers
{
    public class PoliciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Emi,Amount,Image,HospitalId")] Policy policy)
        {
            ...
            ViewData["HospitalId"] = new SelectList(_context.Hospitals, "Id", "Location", policy.HospitalId);
            return View(policy);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Emi,Amount,Image,HospitalId")] Policy policy)
        {
            if (id != policy.Id)
            {
                return NotFound();
